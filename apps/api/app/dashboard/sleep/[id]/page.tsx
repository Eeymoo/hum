...
export default function SleepDetailPage() {
  ...
  if (error === 'not_found') {
    return (
      <div className="p-6">
        <Link href="/dashboard/sleep" className="text-indigo-600 hover:text-indigo-800 mb-4 inline-block">← {t('title')}</Link>
  ...
  return (
    <div className="p-6">
      <Link href="/dashboard/sleep" className="text-indigo-600 hover:text-indigo-800 mb-4 inline-block">
        ← {t('title')}
      </Link>
